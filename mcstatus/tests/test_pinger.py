...
class TestServerPinger:
    ...
    def test_read_status(self):
        ...
        assert status.raw == {"description":"A Minecraft Server","players":{"max":20,"online":0},"version":{"name":"1.8-pre1","protocol":44}}
...
class TestPingResponse:
    def test_raw(self):
        ...
        assert response.raw == {"description":"A Minecraft Server","players":{"max":20,"online":0},"version":{"name":"1.8-pre1","protocol":44}}
